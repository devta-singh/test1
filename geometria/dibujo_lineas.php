...
function _array_polar($im, $centro, $radio, $ang_inicio, $ang_final, $n_div_ang, $color=negro, $estilo="aspa"){
	$margen=5;
	$tamano=4;
...
$_fin=0;
$puntos = _array_polar($im, array(400,400), 350, 0, 360, 10);
$n = sizeof($puntos);
$factor = 1;
for($k = 1; ($k < ($n -1)); $k++){
	if($k==1){
