<?php //texto_sobre_imagen_v3.02a.php
/*
Fichero: texto_sobre_imagen_v3.02a.php
Version: v3.02a
...
Autor: Devta Singh
Fecha: 2018-01-26
Cambios: Solo va con una tarjeta, para poder responder a una URL
*/
...
//imprimimimos tel
imagettftext($im, 23, $ang, $x, $y, $blanco, $fuente2, $tel);
//imagettftext($im, 23, $ang, 80, 370, $blanco, $fuente4, ")H");
$y+=30;
}

if(isset($_REQUEST["tel2"]) && !empty($_REQUEST["tel2"])){
//imprimimimos tel2
imagettftext($im, 23, $ang, $x, $y, $blanco, $fuente2, $tel2);
//imagettftext($im, 23, $ang, 80, 370, $blanco, $fuente4, ")H");
$y+=30;
}
...
//imprimimimos email
imagettftext($im, 23, $ang, $x, $y, $blanco, $fuente2, $email);
$y+=30;
}
