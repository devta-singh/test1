...
for($n_sensor = $num_sensores; $n_sensor >= 1; $n_sensor--){
	...
	for($n_porcion = 1; $n_porcion <= $num_porciones; $n_porcion++){
		...
		imagefilledarc ($im, $cx, $cy, $ancho_mayor, $ancho_mayor, $ang_1, $ang_2, $color1, IMG_ARC_EDGED);
		//imagefilledarc ($im, $cx, $cy, $ancho_menor, $ancho_menor, $ang_1, $ang_2, $color2, IMG_ARC_EDGED);
		$n++;
	}

	imagefilledarc ($im, $cx, $cy, $ancho_menor, $ancho_menor, $ang_ini, $ang_fin, $blanco, IMG_ARC_EDGED);
}
