...
<div>
<div id="barra">
	<form action="?buscar_imagen=1" method="get">
...
-->
	<br>4.Impríme el PDF y corta utilizando las marcas de corte, para que el color llegue al borde de la tarjeta.
	</div>
...
if(isset($_REQUEST["fondo"])){
	$imagen_indicada = $_REQUEST["fondo"];
}else{
	$imagen_indicada = "-sin-imagen-";
}
//$imagen = "imagenes/madrid-1516930809.png";
$imagen = "imagenes/$imagen_indicada";
$url = "http://circulodesanacion.org/tarjetas/$destino";

$salida=print_r($_REQUEST,1);
$log=<<<fin
INCIO
$fecha - $ahora - $ip
-----------------------------------------------------
